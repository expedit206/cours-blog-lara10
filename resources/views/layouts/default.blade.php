...
<path stroke-linecap="round" stroke-linejoin="round" d="M4.2610.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 18.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-
...
<nav x-data="{ open: false }"  class=" relative">
        ...
        class="md:hidden w-8 h-8 flex rounded-full bg-white text-sm 
    ...
    class="md:hidden absolute right-0 z-10 mt-2 w-48 origin-top-right 
    ...
    <li><a href="" class="block px-4 py-2 text-sm text-gray-700 
        ...
        <li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2020" fill="currentColor" class="w-5 h-5 ml-1">
                ...
                .75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 011-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z" clip-rule="evenodd" />
            </svg>
        </a>
    </li>
    </ul>
    ...
    <ul class="hidden md:flex space-x-12 font-semibold">
        ...
        <li>
            <a href="" class="flex items-center group text-indigo-700">
                ...
                stroke="currentColor" class="w-6 h-6 mx-1 group-hover:ml-2 group-hover:mr-0 
                transition-all">
